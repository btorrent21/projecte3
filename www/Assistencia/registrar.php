...
$stmt_update->close();
$conn->close();
echo "<button><a href='media.php' class='btn btn-danger btn-lg'>Faltas</a></button>"
// Redirige de vuelta a la página principal después de registrar las faltas
#echo "<p>Estás utilizando PHP versión " . PHP_VERSION . "</p>";
#header('Location: https://www.insviladegracia.cat/Assistencia/index.php');
#die();
?>
